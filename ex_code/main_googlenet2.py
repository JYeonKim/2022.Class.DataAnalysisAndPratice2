...
def train(image_size, batch_size, num_workers, optimizer_name, learning_rate, nb_epoch):
    ...
    model = GoogLeNet(aux_logits=False, num_classes=7)
...
OMP_NUM_THREADS=1 python main_googlenet2.py --gpu '0' --batch_size 16 --save_path './checkpoint_googlenet/SGD_1e-3_epoch_200' --num_workers 30
