...
# skin_df = pd.read_csv(r'/home/users/s19013225/workspace/dataset/dataverse_files/HAM10000_metadata.csv')


# # Now time to read images based on image ID from the CSV file
# # This is the safest way to read images as it ensures the right image is read for the right ID
# image_path = {os.path.splitext(os.path.basename(x))[0]: x
#               for x in glob(os.path.join('dataset/dataverse_files/', '*', '*.jpg'))}

# print("len(skin_df):",len(skin_df))
...
skin_df2 = pd.read_csv(r'/home/users/s19013225/workspace/data/HAM10000_metadata.csv')
